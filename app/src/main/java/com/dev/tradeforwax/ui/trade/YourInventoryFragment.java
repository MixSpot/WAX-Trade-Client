...
public class YourInventoryFragment extends Fragment {
    ...
    private ResponseYourInventory mResponse = null;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        mAdapter = new InventoryTradeAdapter((InventoryTradeAdapter.Callback) getParentFragment(), (Item.Callback) getParentFragment(), 0);
    ...
    public void refreshInventory(ResponseYourInventory responseInventory) {
        if(mEmptyState != null) {
            mResponse = null;
